...
Vertex* create_graph_ER1(uint N,const __float128 p); //This function creates an array of Vertex structures representing a E-R graph
...
void bin_logaritmic(uint* array_histogram, uint N, __float128 basis, char* filename);
void save_point ( uint N, /* number of vertices */
		  ...
		  char* filename);
void count_graph(uint N_global, __float128 k_av, uint8_t repeats);
